  ...
  return (
    <Sheet>
      ...
      <SheetContent className="overflow-auto h-full">
        <SheetTitle className="items-center justify-center m-3 mx-auto pt-6 lg:text-3xl md:text-2xl sm:text-xl text-3xl">My Cart</SheetTitle>
        <span className="m-2 mx-auto w-4/5  border-b-[1.6px] border-b-gray-700 "></span>
